...
While filesync is running, any files created, edited, or deleted within this local directory will be automatically uploaded to the codebox. The sync happens in less than 2 seconds for most text-based file saves.
